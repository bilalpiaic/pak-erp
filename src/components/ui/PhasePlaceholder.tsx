...
export function PhasePlaceholder({ phase, summary }: PhasePlaceholderProps) {
  return (
    <div className="rounded-md border border-dashed border-[var(--border-strong)] bg-[var(--panel)] px-5 py-8">
      ...
      <p className="mt-4 text-xs text-[var(--muted-strong)]">
        ...
        <span className="font-medium text-[var(--foreground)]">₨1,250,000.00</span>{" "}
